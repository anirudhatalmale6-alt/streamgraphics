...
To put a graphic into OBS or vMix:
  Open a graphic's OUTPUT page and add its URL as a Browser Source (1920x1080).
  The transparency is automatic, so just overlay the browser input and you're set.

To put a graphic into an ATEM:
  Bring the graphic out via HDMI into an ATEM input and add the key. We included an
